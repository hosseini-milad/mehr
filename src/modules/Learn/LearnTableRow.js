...
import LearnQuickDetail from "./CatComponent/LearnQuickDetail"

function LearnTableRow(props){
  ...
  const data=props.data
    return(<React.Fragment>
        <tr 
            ...
            <td>
              <div className="cu-avatar">
                  ...
                  window.location.href="/learn/detail/"+data._id}>
            ...
            <td>
              ...
              <i className={`tableIcon fas ${activeAcc?"fa-chevron-up":"fa-chevron-down"}`} 
                ...
                <i className="tableIcon fas fa-edit" onClick={()=>
                  window.location.href="/learn/detail/"+data._id}></i>
        ...
        <td colSpan="9"><LearnQuickDetail data={data}/></td></tr>
