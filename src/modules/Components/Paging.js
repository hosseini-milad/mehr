...
function Paging(props){
  ...
  return(
    ...
    <select name="page" id="" onChange={(e) => updateUrlWithPagination(props.filters.offset, e.target.value)}>
    <option value="5">5</option>
    <option value="10" selected={props.filters.pageSize === "10"}>10</option>
    ...
    {pageInfo && pageInfo.show ? (
      ...
      onClick={(e, offset) => {
        ...
        props.updateUrlWithFilters({ ...props.filters, offset: offset.toString() });
      }}
      />
      </div>
    ) : (
